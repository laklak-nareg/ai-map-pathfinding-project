...
Where:
- h_base(n) is either Manhattan or Chebyshev (depending on movement).
- wallPenalty(n) counts how many of the 4 neighbouring cells of n are walls.
- lambda (λ) > 0 is a tunable weight.
